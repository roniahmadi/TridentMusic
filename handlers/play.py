...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/a025fc507fb2255d950ea.png"
        ...
        try:
            ...
            while j < 6:
                toxxt += f"{emojilist[j]} [{results[j]['title'][:50]}](https://youtube.com{results[j]['url_suffix']})\n"
...
async def ytplay(_, message: Message):
    ...
    try:
        ...
        user.first_name = "TridentMusicAssistant"
    usar = user
    wew = usar.id
    try:
        # chatdetails = await USER.get_chat(chid)
